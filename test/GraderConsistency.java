...
public class GraderConsistency extends GraderCommonSetup {
	 ...
	 */
	@Test
	public void test10_CreateTables() throws IOException,
			InterruptedException {
		createEmptyTables();
		Thread.sleep(SLEEP);
	 ...
	 */
	@Test
	public void test13_UpdateRecord_RandomServer() throws
	 ...
	 */
	@Test
	public void test14_UpdateRecordFaster_RandomServer() throws
			InterruptedException, IOException {
		// generate a random key for this test
		int key = ThreadLocalRandom.current().nextInt();
	 ...
	 */
	@Test
	public void test15_UpdateRecordMuchFaster_RandomServer() throws
			InterruptedException, IOException {
		// generate a random key for this test
		int key = ThreadLocalRandom.current().nextInt();
	 ...
	 */
	@Test
	public void test16_UpdateRecordFastest_RandomServer() throws
			InterruptedException, IOException {
		// generate a random key for this test
		int key = ThreadLocalRandom.current().nextInt();
